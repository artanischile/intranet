...
.bg-menu {
    background-image: url('assets/frontend/img/synapse/bg-header.png');
    min-height: 120px;
}
...
.bg-section-1 {
    background-image: url('assets/frontend/img/synapse/BAN01.jpg');
    min-height: 410px;
...
.bg-section-2 {
    background-image: url('assets/frontend/img/synapse/BAN02.jpg');
    min-height: 702px;
        ...
        <div class="container">
            ...
            <div class="col-lg-12  bg-menu  ">
                 <div class="col-lg-3 logo">
                        <img src="assets/frontend/img/synapse/logo.png" class="img-responsive">
                 </div>
            ...
            <div class="col-lg-12 bg-section-1  no-padding " style="position: relative;">
                   <div class="box-text">
                       <div class="h2">UNA MÁQUINA<br/>DISEÑADA PARA<br/> LARGOS RECORRIDOS</div>
                   </div>
            ...
            <div class="col-lg-12 bg-section-2 ">
                  ...
                  <div class="col-lg-6 left-35">
                      <div class="text-razones ">
                        RENDIMIENTO <br />A TODA PRUEBA
                      </div> 
                      <div class="col-lg-6 no-padding texto-descriptivo ">
                        <p>LA MÁQUINA DE RESISTENCIA</p>
                        <p>Fabricada para grandes distancias y largos días sobre el sillín, sistema de micro-suspensión que lo aísla de los obstáculos sin aislarlo de la experiencia. </p>
                      </div>
                      <div class="col-lg-6 no-padding texto-descriptivo border-left">
                        <p>RENDIMIENTO DE CARRERA</p>
                        <p>Pesa solo 950 g (unos 220 g más ligero) nivel de rigidez reservado normalmente para los equipos de corredores del circuito mundial. Esta máquina es muy rápida.</p> 
                      </div>
                      <div class="clear"></div>
                      <div class="col-lg-6 no-padding texto-descriptivo border-top">
                        <p>COMODIDAD CON CONEXIÓN</p>
                        <p>Micro-suspensión SAVE PLUS (hasta 1.8cm de recorrido vertical) en el cuadro, horquilla, tubo de asiento, para crear rendimiento y protegerte de impactos y vibraciones, sin perder eficiencia.</p>  
                      </div>
                      
                      <div class="col-lg-6 no-padding texto-descriptivo border-top">
                            <p>GEOMETRÍA DE CARRERA Y RESISTENCIA</p>
                            <p>La posición del ciclista equilibra perfectamente la posición erguida para otorgarle una sensación perfecta que favorece las hazañas extremas y las sesiones de todo el día.</p>  
                      </div>
                      
                      <div class="clear"></div>
                      
                      <div class="col-lg-6 no-padding texto-descriptivo border-top">
                            <p>DISEÑO CON TAMAÑO ÓPTIMO</p>
                            <p>Nueva Filosofía de fabricación con tamaños específicos, único de Cannondale. Cada talla de cuadro posee sus propias medidas, además son tres diámetros diferentes en el rodamiento de dirección y pipa de dirección, además tres off-sets distintos de horquilla así poseen la misma sensación de rigidez y conducción, sea cual sea su talla.</p>  
                      </div>
                      <div class="col-lg-6 no-padding texto-descriptivo border-top">
                            <p>AMPLIAS CAPACIDADES DE AJUSTE</p>
                            <p>Con holgura para neumáticos de un ancho más grande, hasta 32 mm y montajes de guardabarros ocultos y sutiles.</p>  
                      </div>
                  ...
                  <div class="col-lg-4 col-xs-12 col-lg-offset-1 no-padding">
                   <div class="neg-top">
                      ...
                      <div class="logo-in-form" >
                        <img src="assets/frontend/img/synapse/logo-bajo-form.png" class="img-responsive center-block" />
                      </div>
            ...
            <div class="col-lg-8 col-lg-push-2" style="margin-top: 25px ;  margin-bottom: 40px">
                <img src="assets/frontend/img/synapse/bici.png" class="center-block img-responsive" >
            </div>
            ...
            <div class="col-lg-12 bg-section-3 alternate-bg " style="padding-top:8%">
               ...
               <div class="col-lg-3 " style="padding-top: 30px"><a href="https://www.intercycles.cl/synapse" target="_blank" type="button" class="btn btn-default">COMPRAR</a></div>
            </div>
            <style>
               .bag{
                background:#0098CA ;
