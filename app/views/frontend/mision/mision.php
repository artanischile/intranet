<!--Start Title-->
<div class="page-title fix" style="background:url(<?php echo base_url('assets/frontend/')?>img/mision/Banner_Mision.jpg) no-repeat scroll top left / cover ;height: 509px;">
</div>
<!--End Title-->
...
<section class="about-page page fix"><!--Start About Area-->
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-6">
				<div class="about-text">
					<p class="p-mision">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
                    <p class="p-mision">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
                    <p class="p-mision">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
                    <p class="p-mision">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
                    <p class="p-mision">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
			...
			<div class="col-sm-6">
				<div class="about-img">
					<img src="<?php echo base_url('assets/frontend/')?>img/mision/imagenside.png" alt="" />
				</div>
			</div>
		</div>
	</div>
