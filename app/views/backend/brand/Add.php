        ...
        <div class="col-lg-12 m-t-20">
            ...
            <div class="col-lg-6 ">
                <div class="form-group row">
                    ...
                    <div class="col-lg-2">
                        <input type="text" placeholder="" id="brand_id" name="brand_id" class="form-control"
                            value="<?php echo isset($data['brand_id'])? $data['brand_id'] : '' ?>" autocomplete="off"
                            readonly />
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        <input type="text" placeholder="Nombre Marca" id="brand_name" name="brand_name"
                            class="form-control"
                            value="<?php echo isset($data['brand_name'])? $data['brand_name'] : '' ?>" required=""
                            parsley-type="alphanum" autocomplete="off" />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        <input type="file" placeholder="" id="brand_image" name="brand_image" class="form-control"
                            value=""
                            autocomplete="off" style="padding-bottom: 42px;" required="" />
                        <div class="text-danger small e_enterprise_rut"><?php echo $errors['brand_image'] ?></div>
                    </div>
                </div>

                <div class="form-group row">
                    <label for="inputEmail3" class="col-lg-4 form-control-label">Estado:<span
                            class="text-danger">*</span></label>
                    <div class="col-lg-8">
                        <select class="form-control" id="brand_status" required="" name="brand_status">
                            <option value="">Seleccione</option>
                            <?php foreach($status as $sts):?>
                            <option value="<?php echo $sts->status_value;?>"
                                <?php echo isset($data['brand_status']) ?  $sts->status_value==$data['brand_status'] ? 'selected' : ''   :  '' ?>>
                                <?php echo $sts->status_name;?></option>
                            <?php endforeach;?>
                        </select>
                ...
                <input type="hidden" name="hdImage"
            ...
            <div class="col-lg-6">
                <div>
                    <img class="center_block img-responsive"   src="<?php echo base_url() . $data['brand_image']?>"   alt="<?php ?>">
                    <input type="hidden" name="hd_image_brand" value="<?php $data['brand_image']?>">
                </div>
            </div>
