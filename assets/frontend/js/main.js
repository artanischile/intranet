(function ($) {
    ...
    $(document).ready(function ($) {
        ...
        $('.mobile > ul > li > ul > li > a').click(function () {

            var comprobar2 = $(this).next();
            console.log(comprobar2);
            $(this).closest('li').addClass('activa');

            if ((comprobar2.is('ul')) && (comprobar2.is(':visible'))) {
                console.log('on');
                $(this).closest('li').removeClass('activa');
                comprobar2.slideUp('normal');
            }

            if ((comprobar2.is('ul')) && (!comprobar2.is(':visible'))) {

                $('.mobile ul ul ul:visible').slideUp('normal');
                comprobar2.slideDown('normal');
            }
        });
